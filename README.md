...
I focused on several characteristics such as:
    ...
    Gender
    Health
    Number of photos (One of the strongest predictors on adoption speed)
...
Most important predictors:
    ...
    Age
    Number of photos
State distribution shows high concentration in PetFinder state codes 41326 and 41401 (Malaysia regions, not U.S. states).